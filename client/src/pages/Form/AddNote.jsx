...
function AddNote() {
  return (
    <>
        <Navbar/>
        <div className="flex h-auto items-center pt-40 m-4">
            <form className="w-96 mx-auto mt-20">
                ...
                <button className="bg-sky-500 text-slate-100 w-full p-2 focus:outline-none focus:border-sky-500 rounded-md mb-4 text-sm" >Create</button>
            </form>
        </div>
        {/* <Footer/> */}
    </>
